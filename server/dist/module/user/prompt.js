...
exports.DEFAULT_FIRST_MESSAGES = void 0;
exports.buildDefaultPrompt = buildDefaultPrompt;
exports.DEFAULT_FIRST_MESSAGES = {
    receptionist: "Hello! Thank you for calling. How can I help you today?",
    appointment: "Hi there! I can help you book an appointment. What service are you looking for?",
    faq: "Hello! I'm here to answer any questions you have. What would you like to know?",
};
function buildDefaultPrompt(type, businessName) {
